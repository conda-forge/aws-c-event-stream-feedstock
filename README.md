...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-c-event-stream-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-c-event-stream-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aws-c-event-stream
# for installing globally
pixi global install aws-c-event-stream
```
...
It is possible to list all of the versions of `aws-c-event-stream` available on your platform:
...
```
pixi search aws-c-event-stream --channel conda-forge
```
